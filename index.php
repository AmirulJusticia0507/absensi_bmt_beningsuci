                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text">Melakukan transfer ke rekening lain</p>
                                <button onclick="location.href='transfer.php'" class="btn btn-primary">Transfer</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text">Bayar menggunakan QR Code</p>
                                <button onclick="location.href='qris.php'" class="btn btn-primary">QRIS</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text">Lihat mutasi rekening</p>
                                <button onclick="location.href='mutasi.php'" class="btn btn-primary">Mutasi</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title">Aktivitas Payment</h5>
                                <p class="card-text">Lihat aktivitas pembayaran</p>
                                <button onclick="location.href='aktivitas_payment.php'" class="btn btn-primary">Aktivitas Payment</button>
                            </div>
                        </div>
                    </div>
                </div> -->
